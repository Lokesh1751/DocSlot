...
function MidHeaderSection() {
  return (
    <div className="relative flex h-[170px] items-center justify-center m-4">
      <div className="absolute flex flex-col gap-4 p-4 items-center rounded-xl bg-[#0143BE] top-[-50px] w-full mx-auto sm:flex-row sm:gap-8 sm:p-6 md:top-[-50px] xl:top-[-60px] xl:flex-row xl:gap-12 xl:p-8 xl:rounded-2xl xl:justify-evenly xl:w-[80%]">
